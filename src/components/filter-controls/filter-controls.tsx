    ...
    <form ref={formRef} id="filter-controls" className="filter-controls filter" onSubmit={callbacks.submitHandler}>
      <fieldset className="filter__fieldset">
        ...
        <div className="filter__group">
          <label className="filter__label">From date:</label>
          <input
        ...
        <div className="filter__group">
          <label className="filter__label">To date:</label>
          <input className="filter__date-to" name="dateTo" type="date" defaultValue={dateToInputValue(filter.dateTo)} />
        </div>

        <div className="filter__group">
          <label className="filter__label">By text content:</label>
          <input
        ...
        <div className="filter__group">
          <label className="filter__label">By status:</label>
          <select
        ...
        <div className="filter__group">
          <label className="filter__label">By tag:</label>
          <input
