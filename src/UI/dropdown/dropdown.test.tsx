...
describe("Dropdown", () => {
  ...
  it("should render with data", () => {
    const component = render(<Dropdown name="select" items={["1", "2", "3"]} selected="1" changeHandler={() => {}} />);
  ...
  it("should call callback on value change", async () => {
    ...
    const { user } = setup(
      <Dropdown name="select" items={["year", "month", "date"]} selected="year" changeHandler={changeHandler} />,
    );
